...
CREATE TABLE `status_game` (
  ...
  `name` enum('finished',' proceed','not started') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `status_game` VALUES (1,'finished'),(2,'not started'),(3,' proceed');
...
-- Dump completed on 2021-07-28 23:09:17
